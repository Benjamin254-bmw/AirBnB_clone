...
"""define module of entry cmd intrpreter"""
...
class HBNBCommand(cmd.Cmd):
    ...
    def do_destroy(self, line):
        ...
        if len(arr) < 1:
            ...
            new_str = f"{arr[0]}.{arr[1]}"
            if new_str not in storage.all().keys():                print("** no instance found **")
            else:
